...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        <h1 class="display-4">51Tracking API PHP SDK Testing</h1>
        <p class="lead">This is the official PHP SDK of 51Tracking API. Provided by 51Tracking</p>
        <hr class="my-4">
        <a href="mailto:service@51tracking.org">service@51tracking.org</a>
    </div>
</div>
<!---->
    ...
    <form action="testing.php" method="GET" id="form" class="form">
        <div class="form-group">
            ...
            <div class="help-block">
                <a href="https://www.51tracking.com/v4/api-index/API-" target="_blank">How to generate 51Tracking API Key?</a>
            </div>
        </div>
        <hr class="my-4">
		...
		<?php
		$couriers         = new \Tracking51\Couriers( $api_key );
		$trackings        = new \Tracking51\Trackings( $api_key );
		$airWaybill = new \Tracking51\AirWaybills( $api_key );
		?>
                ...
                <td>
					<?php if ( $request_all || $action == 'v4/trackings/create' ) {
						pr_result( function () use ( $trackings ) {
                            $params = [
                                'tracking_number'=>'92612903029511573030094531',
                                'courier_code'=>'usps',
                                'order_number'=>'',
                                'customer_name'=>'',
                                'title'=>'',
            ...
            <tr>
                ...
                <td>
					<?php if ( $request_all || $action == 'v4/trackings/get' ) {
						pr_result( function () use ( $trackings ) {
                            $params = ['tracking_numbers'=>'92612903029511573030094531','courier_code'=>'usps'];
